...
if(isset($_POST["num"])){
	...
	$sql = "UPDATE userinfo SET mobile='$num', email='$alt_e', updatedate=now() WHERE username='$log_username'";
...
if($mobile == "NULL" || $mobile == NULL){
	$mobile =  '';
}if($alt_email == "NULL" || $alt_email == NULL){
	$alt_email =  '';
}
?><?php
      ...
      <ul class="ca qo anx">
        <li class="qf b aml">
		  <div class="qv rc EditBx">
			<div class="qw">
			  <h5 class="ald"> Edit Contact</h5>
			  <form role="form" method="post" id="contactAbout" onSubmit="return false;">
				  <hr class="dp">
				  <div class="qn">
					<div class="qn">
						<h5 class="dp" style="padding: 5px;">Mobile number &nbsp;<span class="fa fa-phone"></h5>	
						<input type="text" name="number" value="<?php echo $mobile; ?>" onfocus="emptyElement('status2')" placeholder="Phone number" id="number" class="form-control inputBox" autofocus>
					</div>
				  </div>
				  <hr class="dp">
				  <div class="qn">
					<div class="qn">
						<h5 class="dp" style="padding: 5px;">Alternative Email &nbsp;<span class="fa fa-envelope-o"></h5>
						<input type="email" name="email" value="<?php echo $alt_email; ?>" onfocus="emptyElement('status2')" placeholder="Alternative Email" id="email" class="form-control inputBox" autofocus>
					</div>
				  </div>
				  <hr class="dp">
				  <div id="editContactBtn">
				    ...
				    <button class="cg fm" style="border:1px solid grey;" onclick="contactAbout()">Save changes &nbsp;<span class="fa fa-save"></span></button>
...
function contactAbout(){
	...
	if(num == "" || alt_e == ""){
		...
		var ajax = ajaxObj("POST", "contactinfo.php");
