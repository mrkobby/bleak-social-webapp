...
if(isset($_REQUEST["msg"])){
	...
	$sql = "INSERT INTO chat (user1, user2, msg_data, timesent) VALUES ('$log_username','$user2','$msg',now())";
...
while ($row = mysqli_fetch_array($query, MYSQLI_ASSOC)) {
	...
	$msglist .= ''.$msgDeleteButton.'<div class="aod"><small class="dp"><a href="../profile/?u='.$user1.'">'.$user1.'</a>&nbsp; <time class="timeago" datetime="'.$timesent.'">'.$timesent.'</time></small></div></div></li>';
	}else{
